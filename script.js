...
formulario.addEventListener(`submit`,(e) => {
    ...
    const tiquete1 = () => {
        (carteleras === null) ? alert("la pelicula esta mal señalada") : (horarios === null) ? alert("el horario esta mal señalado") : (cantidadClientes === null) ? alert("los clientes estan mal señalados") :  tiquete = new tiquetes(carteleras,horarios,cantidadClientes,bebidaA,palomitasA,comidaA) 
    }
    tiquete1()

    const guardarticketes = () =>{
        reservaciones.push(tiquete) 
        reservacionesmostrar.push(tiquete)
    }

    (tiquete === null)||(tiquete === undefined) ? alert("vuelve a ingresar tu ticket") : guardarticketes()
